...
import type { Customer, LoginResponseDto, Order, OrderHistory } from "./client/api/types.gen";

export const authState = atomWithStorage<LoginResponseDto | null>("authState", null);
