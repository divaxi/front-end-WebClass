...
const SelectField: React.FC<SelectFieldProps> = ({
    ...
    if (!control || !setValue) {
        console.error("Control and setValue props are required for SelectField component");
        return null;
    }
    ...
    return (
        <Controller
            ...
            render={({ field, fieldState: { error } }) => {
                ...
                const selectedOption = options.find(opt => opt.value === currentValue?.value) || null;
